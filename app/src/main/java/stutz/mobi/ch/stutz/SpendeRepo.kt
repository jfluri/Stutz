...
class SpendeRepo {
    ...
    val allSpenden = listOf(Spende(UUID.fromString("ed67b912-8161-477a-a081-558f12cdfa74"), UUID.fromString("d56f7fdd-9dfa-4022-aa55-b14b480715ee"), UUID.fromString("567dae99-7763-4781-b3fa-c7443894e342"), 5.00, Date()),
